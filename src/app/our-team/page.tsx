        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-body-lg text-[#6B6B6B] leading-relaxed">
              Meet the dedicated individuals anchoring our vision through hands-on service
              and strategic compassion — across Central, Jabalpur, Indore, and Social Media.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            {CATEGORIES.map((cat) => (
              <button
                ...
                className={`px-6 py-2.5 rounded-full text-body-sm font-semibold transition-all duration-300 border-2 ${
                  activeTab === cat
